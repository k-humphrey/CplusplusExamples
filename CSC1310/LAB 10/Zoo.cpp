/*
	filename: Zoo.cpp
	author: partially Kayla Humphrey
	date: 11/15/2023
	purpose: driver for a min heap
*/
#include "Creature.h"
...
int main()
{
	...
	do{
		...
		switch(choice)
		{
			...
			case 3: //this dont work lol
					removed = creatureHeap.peek();
					if(creatureHeap.remove(removed)){
						cout << "\n\nYou have removed " << removed.getName();
					}
					break;
